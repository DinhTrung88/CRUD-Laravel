...
<body>
    <form method="GET" action="{{ route('student.index') }}">
        ...
        <input style="margin-bottom: 10px;" name="code" placeholder="Mã sinh viên" type="text"
            value="{{ isset($_GET['code']) ? $_GET['code'] : '' }}">
        <div style="font-weight: bold;">Name:</div>
        <input style="margin-bottom: 10px;" name="name" type="text" placeholder="Tên sinh viên"
        ...
        <div style="display: flex; justify-content: space-between; width: 60px;">
            ...
            <input id="male-id" style="margin-bottom: 10px;" name="sex" value="nam" type="radio"
                placeholder="Giới tính">
            <label for="female-id" style="font-weight: bold; margin-left: 20px;">Female</label>
            <input id="female-id" style="margin-bottom: 10px;" name="sex" type="radio" value="nu"
                placeholder="Giới tính">
            <label for="female-id" style="font-weight: bold; margin-left: 20px;">Lgbt</label>
            <input id="female-id" style="margin-bottom: 10px;" name="sex" type="radio" value="lgbt"
                placeholder="Giới tính">
        </div>
