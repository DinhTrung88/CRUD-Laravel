...
<body>
    ...
    <form method="post" action="{{ route('student.store') }}">
        ...
        <span>Nam: </span>
        <input type="radio" name="gender" value="nam" {{ old('gender') === 'nam' ? 'checked' : '' }}>
        <span>Nu: </span>
        <input type="radio" name="gender" value="nu" {{ old('gender') === 'nu' ? 'checked' : '' }}>
        <span>Lgbt:</span>
        <input type="radio" name="gender" value="lgbt" {{ old('gender') === 'lgbt' ? 'checked' : '' }}>
        ...
        <input type="text" name="address" value="{{ old('adress') }}">
        @error('adress')
            <span class="error">{{ $message }}</span>
        @enderror
